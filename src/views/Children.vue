      ...
      <div v-for="product in filteredClothes" v-bind:key="product.id">
        <div class="card text-center">
          ...
          <div class="card-footer justify-content-center">
            <button @click="addItem(product)" class="btn back-color-button">Handla<img class="ml-2 mb-1" src="../assets/images/shopping-bag.svg" alt="" /></button>
          </div>
        </div>
      </div>
    </div>
